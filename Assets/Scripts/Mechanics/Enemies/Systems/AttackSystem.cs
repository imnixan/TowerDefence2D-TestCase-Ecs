...
sealed class AttackSystem : IEcsRunSystem
{
    ...
    private EcsFilter<Attacker, HasTargets> attackFilter;
    ...
    public void Run()
    {
        foreach (int i in attackFilter)
        {
            ...
            ref Attacker attacker = ref attackFilter.Get1(i);
            ref ObjectComponent objComp = ref attackerEntity.Get<ObjectComponent>();
            ref HasTargets wantKillTarget = ref attackFilter.Get2(i);
